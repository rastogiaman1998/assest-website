...
<div class="col-md-12">
<?php include_once('./sections/addCustomerInfo.php') ?>
</div>
</div>

   <!----  add customer infomation ends ------->
    <br>
     <h3 class="alert alert-light"> Customer List </h3>
    
    <section id="products" >
        <div class="row cardbox">
            <div class="col-md-12">
            
                <?php include_once('./sections/customerList.php');   ?>
            </div>
        </div>
        </section>
